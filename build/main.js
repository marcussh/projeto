...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_eventos_eventos__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_storage__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__eventos_eventos__ = __webpack_require__(53);
...
var HomePage = (function () {
    function HomePage(navCtrl, geo, storage, uniqueDeviceID) {
        ...
        this.statusPerimetro = [];
        this.statusChegada = false;
        this.latEvento = -15.753773;
        this.lngEvento = -47.878711;
        this.unit = "K";
    ...
    HomePage.prototype.ionViewDidLoad = function () {
        var _this = this;
        //setTimeout("atualizaLoc()", 3000);
        //console.log(setInterval("atualizaLoc()", 3000));
    ...
    HomePage.prototype.atualizaLoc = function () {
        var _this = this;
        if (this.statusChegada == true) {
            console.log("foi");
            this.geo.getCurrentPosition().then(function (pos) {
                _this.lat = pos.coords.latitude;
                _this.lng = pos.coords.longitude;
            ...
            this.now = __WEBPACK_IMPORTED_MODULE_4_moment__().format('MMMM Do YYYY, h:mm:ss a');
            this.statusPerimetro.push(this.verifica(this.distance(this.lat, this.lng, this.latEvento, this.lngEvento, this.unit)));
        }
        else {
            console.log("não foi");
        }
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\Marcus Vinicius\Documents\Projeto PPI2\projeto_v2\src\pages\home\home.html"*/`<ion-header>\n  <!-- <meta http-equiv="refresh" content="3"> -->\n  <ion-navbar>\n      <button ion-button menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n        <ion-grid>\n            <ion-row>\n              <ion-col>ConectaIF 2019</ion-col>\n             \n              <ion-col> \n                <ion-badge style="float: right;" color="secondary" item-end (click)="remove()">Sair</ion-badge>\n                </ion-col>\n            </ion-row>\n          </ion-grid>\n  </ion-navbar>\n</ion-header>\n\n\n  \n\n<ion-content padding>\n  \n  <button ion-button block (click)="pegarLocalizacao()">Registrar Chegada</button>\n  <h2>Log</h2>\n  <p>Latitude Aluno: {{ lat }}</p>\n  <p>Longitude Aluno: {{ lng }}</p>\n  <p>-------------</p>\n  <p>Latitude Evento: {{ latEvento }}</p>\n  <p>Longitude Evento: {{ lngEvento }}</p>\n  <p [hidden]=true>{{ unit }}</p>\n  <p>-------------</p>\n  <p>Hora da chegada: {{ now }}</p>\n  <p>Distância do evento: {{ distance(lat, lng, latEvento, lngEvento, unit) }}</p>\n  <p>Status: {{ verifica(distance(lat, lng, latEvento, lngEvento, unit)) }}</p>\n\n  <!-- <button ion-button (click)="distance(lat, lng, latEvento, lngEvento, unit)">Calcular localização</button> -->\n  <p *ngFor="let status of statusPerimetro">\n    {{ status }}\n\n  </p>\n  \n</ion-content>\n`/*ion-inline-end:"C:\Users\Marcus Vinicius\Documents\Projeto PPI2\projeto_v2\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
...
var EventosPage = (function () {
    ...
    EventosPage.prototype.selecionaEvento = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__eventos_eventos__ = __webpack_require__(53);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        if (this.validaCPF(this.formulario.value.cpf) == true) {
            if (this.stSessao == false) {
                var alerta = this.alert.create({
                    ...
                    message: "É necessário cadastrar o seu smartphone: \n\n Seu MAC: 00:19:B9:FB:E2:57",
                    // inputs: [
                    //   {
                    //     name: 'mac'
                    //   }],
                    buttons: [
                        ...
                        },
                        {
                            text: "Confirmar",
                            handler: function () {
                                _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_5__eventos_eventos__["a" /* EventosPage */]);
                            }
                            // handler: data => {
                            // this.storage.set("mac", data.mac);
